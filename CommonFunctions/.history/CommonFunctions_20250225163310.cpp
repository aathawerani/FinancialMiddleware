...
bool CommonFunctions::strMatch(const char* src, const char* dest) {
    ...
    static bool ConvWCSToMBS(std::string& cStr, const std::wstring& wStr) {
    ...
    static bool ConvMBSToWCS(std::wstring& wStr, const std::string& cStr) {
    ...
    static std::vector<KeyValue> parseKeyValueString(const std::string& input) {
    ...
    static bool asciiToHex(std::vector<unsigned char>& buffer) {
    ...
    static void hexToAscii(std::vector<unsigned char>& buffer) {
