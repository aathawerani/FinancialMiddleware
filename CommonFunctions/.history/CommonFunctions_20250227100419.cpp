...
const std::array<unsigned char, 256> ASCII_TO_EBCDIC = {
    /* 0x00 - 0x0F */ 0x00, 0x01, 0x02, 0x03, 0x9C, 0x09, 0x86, 0x7F, 0x97, 0x8D, 0x8E, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F,
    /* 0x10 - 0x1F */ 0x10, 0x11, 0x12, 0x13, 0x9D, 0x85, 0x08, 0x87, 0x18, 0x19, 0x92, 0x8F, 0x1C, 0x1D, 0x1E, 0x1F,
    /* 0x20 - 0x2F */ 0x40, 0x5A, 0x7F, 0x7B, 0x5B, 0x6C, 0x50, 0x7D, 0x4D, 0x5D, 0x5C, 0x4E, 0x6B, 0x60, 0x4B, 0x61,
    /* 0x30 - 0x3F */ 0xF0, 0xF1, 0xF2, 0xF3, 0xF4, 0xF5, 0xF6, 0xF7, 0xF8, 0xF9, 0x7A, 0x5E, 0x4C, 0x7E, 0x6E, 0x6F,
    /* 0x40 - 0x4F */ 0x7C, 0xC1, 0xC2, 0xC3, 0xC4, 0xC5, 0xC6, 0xC7, 0xC8, 0xC9, 0xD1, 0xD2, 0xD3, 0xD4, 0xD5, 0xD6,
    /* 0x50 - 0x5F */ 0xD7, 0xD8, 0xD9, 0xE2, 0xE3, 0xE4, 0xE5, 0xE6, 0xE7, 0xE8, 0xE9, 0xBA, 0xE0, 0xBB, 0xB0, 0x6D,
    /* 0x60 - 0x6F */ 0x79, 0x81, 0x82, 0x83, 0x84, 0x85, 0x86, 0x87, 0x88, 0x89, 0x91, 0x92, 0x93, 0x94, 0x95, 0x96,
    /* 0x70 - 0x7F */ 0x98, 0x99, 0xA2, 0xA3, 0xA4, 0xA5, 0xA6, 0xA7, 0xA8, 0xA9, 0xC0, 0x4A, 0xE1, 0xBB, 0xE0, 0x6A,
    /* 0x80 - 0x8F */ 0xB1, 0xB2, 0xB3, 0xB4, 0xB5, 0xB6, 0xB7, 0xB8, 0xB9, 0xAB, 0xBC, 0xBD, 0xBE, 0xBF, 0xCA, 0xCB,
    /* 0x90 - 0x9F */ 0xCC, 0xCD, 0xCE, 0xCF, 0xDA, 0xDB, 0xDC, 0xDD, 0xDE, 0xDF, 0xEC, 0xED, 0xEE, 0xEF, 0xFC, 0xFD,
    /* 0xA0 - 0xAF */ 0xFE, 0xFA, 0xFB, 0xCD, 0xAF, 0xAE, 0xAD, 0xAC, 0xAA, 0xA1, 0x8C, 0x8D, 0x8E, 0x8F, 0x9A, 0x9B,
    /* 0xB0 - 0xBF */ 0x9E, 0x9F, 0x9C, 0x9D, 0xE1, 0x4F, 0x6A, 0x8A, 0x8B, 0xB2, 0xB3, 0xB4, 0xB5, 0xB6, 0xB7, 0xB8,
    /* 0xC0 - 0xCF */ 0xB9, 0xBA, 0xBB, 0xBC, 0xBD, 0xBE, 0xBF, 0xCA, 0xCB, 0xCC, 0xCD, 0xCE, 0xCF, 0xDA, 0xDB, 0xDC,
    /* 0xD0 - 0xDF */ 0xDD, 0xDE, 0xDF, 0xEC, 0xED, 0xEE, 0xEF, 0xFC, 0xFD, 0xFE, 0xFA, 0xFB, 0xCD, 0xAF, 0xAE, 0xAD,
    /* 0xE0 - 0xEF */ 0xAC, 0xAA, 0xA1, 0x8C, 0x8D, 0x8E, 0x8F, 0x9A, 0x9B, 0x9E, 0x9F, 0x9C, 0x9D, 0xE1, 0x4F, 0x6A,
    /* 0xF0 - 0xFF */ 0x8A, 0x8B, 0xB2, 0xB3, 0xB4, 0xB5, 0xB6, 0xB7, 0xB8, 0xB9, 0xBA, 0xBB, 0xBC, 0xBD, 0xBE, 0xBF
};
...
int CommonFunctions::asciiToEbcdic(std::span<unsigned char> buffer) {
    ...
    std::cout << "ASCII_TO_EBCDIC[0x41]: " << std::hex << static_cast<int>(ASCII_TO_EBCDIC[0x41]) << "\n";
    std::cout << "ASCII_TO_EBCDIC[0x42]: " << std::hex << static_cast<int>(ASCII_TO_EBCDIC[0x42]) << "\n";
    std::cout << "ASCII_TO_EBCDIC[0x43]: " << std::hex << static_cast<int>(ASCII_TO_EBCDIC[0x43]) << "\n";
    for (auto& byte : buffer) {
        unsigned char original = byte;
