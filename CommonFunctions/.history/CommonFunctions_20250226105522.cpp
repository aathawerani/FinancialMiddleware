...
std::string CommonFunctions::ebcdicToAscii(const std::string& ebcdicStr) {
    static const unsigned char EbcdicToAsciiTable[256] = {
        // (Same lookup table as before)
    };
...
std::string CommonFunctions::asciiToEbcdic(const std::string& asciiStr) {
    static const unsigned char AsciiToEbcdicTable[256] = {
        // (Same lookup table as before)
    };
